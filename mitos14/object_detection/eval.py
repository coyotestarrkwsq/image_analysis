...
flags.DEFINE_string('training_process', '',
                    'process id of training')
...
def main(unused_argv):
  ...
  evaluator.evaluate(FLAGS.training_process, mitosis_map, mitosis_class, create_input_dict_fn, model_fn, eval_config, categories,
